...
export class PostgresAdapter implements IDatabase {
  ...
  async getPublishedPosts(): Promise<PostSummary[]> {
    ...
    return allPosts.map((post) => ({
      ...
      pinned: post.pinned,
      publishAt: this.nullableTs(post.publishAt),
  ...
  async createPost(data: CreatePostInput): Promise<Post> {
    ...
    return {
      ...
      publishAt: this.nullableTs(newPost.publishAt),
  ...
  async updatePost(slug: string, data: UpdatePostInput): Promise<Post | null> {
    ...
    return {
      ...
      publishAt: this.nullableTs(updated.publishAt),
  ...
  async exportAll(): Promise<BackupData> {
    ...
    return {
      ...
      posts: allPosts.map((p) => ({
        ...
        pinned: p.pinned,
        publishAt: this.nullableTs(p.publishAt),
